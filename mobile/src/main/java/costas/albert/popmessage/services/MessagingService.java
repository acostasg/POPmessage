...
public class MessagingService extends Service {
    public static final String READ_ACTION =
            "costas.albert.popmessage.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "costas.albert.popmessage.ACTION_MESSAGE_REPLY";
    ...
    public void sendNotification(int conversationId, String message,
